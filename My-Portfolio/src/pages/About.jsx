    ...
    <section className="py-20 md:py-24 bg-background-light dark:bg-background-dark transition-colors duration-100">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          Hello! I’m Bhawya, a pre-final year Computer Science student and aspiring Software Engineer.
          I have a good understanding of full-stack web development, especially using the MERN stack (MongoDB, Express.js, React, Node.js), and I’m comfortable working with RESTful APIs and basic frontend-backend integration. I also have a strong grasp of Data Structures, Algorithms, and Object-Oriented Programming, which helps me write clean and efficient code. I’m constantly learning through personal projects and hands-on problem solving, and I’m excited to contribute to real-world software development teams.
          </motion.p>
  ...
  Pre-final year B.Tech student in Computer Science and Engineering<br />
            ...
            <div>
              ...
              <motion.ul variants={listVariants} className="list-disc list-inside text-lg space-y-1">
                ...
                <motion.li variants={listItemVariants}>C++,C</motion.li>
          ...
          <motion.ul variants={listVariants} className="list-disc list-inside text-lg space-y-1 mb-8">
            <motion.li variants={listItemVariants}>Cyber Security and Ethical Hacking</motion.li>
            <motion.li variants={listItemVariants}>Building my own projects</motion.li>
            <motion.li variants={listItemVariants}>Learning new technologies</motion.li>
          </motion.ul>
