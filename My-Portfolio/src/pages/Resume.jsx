...
import ResumePDF from '../assets/bhawya_resume.pdf'; // Make sure you have your resume.pdf in src/assets/
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <a
            ...
            aria-label="Download Bhawya's Resume"
          >
            Download Resume (PDF)
          </a>
        </motion.div>
